...
/obj/item/encryptionkey/headset_fiends
	name = "Fiend radio encryption key"
	desc = "An encryption key for a radio headset.  To access the Fiend channel, use :a."
	icon_state = "cypherkey"
	channels = list(RADIO_CHANNEL_FIENDS = 1)
