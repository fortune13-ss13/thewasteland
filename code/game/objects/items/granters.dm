...
/obj/item/book/granter/crafting_recipe/gunsmithing
	///Determines the level of tech it gives in the autolathe. These could be flags but I can't be bothered, it'll do.
	var/autolathe_level
...
/obj/item/book/granter/trait/selection
	...
	pages_to_mastery = 0
	time_per_page = 0
	var/choices = list("Big Book of Science","Dean's Electronics","Grognak the Barbarian","First Aid Pamphlet","Wasteland Survival Guide")
