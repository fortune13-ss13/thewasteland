...
/obj/item/storage/backpack/Ncrbannerpack
	...
	desc = "A backpack with a big banner. Meant to be used in frontal assualts for moral."
...
/obj/item/storage/backpack/duffelbag/duffel-Slav
	name = "Scav duffel bag"
	desc = "A large duffel bag for holding Vodka and Sunflower seeds."
	icon_state = "duffel-Slav"
	item_state = "duffel-Slav"

/obj/item/storage/backpack/holding/Attackpack2
	name = "Assault Pack"
	desc = "A massive assault back, looks really heavy though."
	icon_state = "Attackpack2"
	item_state = "Attackpack2"
	slowdown = 3
