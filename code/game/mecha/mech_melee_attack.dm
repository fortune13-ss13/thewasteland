...
/atom/proc/mech_melee_attack(obj/mecha/mecha_attacker)
	return

/turf/closed/wall/mech_melee_attack(obj/mecha/mecha_attacker)
...
/obj/mech_melee_attack(obj/mecha/mecha_attacker)
	mecha_attacker.do_attack_animation(src)
...
/obj/structure/window/mech_melee_attack(obj/mecha/mecha_attacker)
	if(!can_be_reached())
		return
	return ..()
/*
