...
#define INSTITUTE	(1<<12)

#define F13COURSERLEADER (1<<0)
#define F13COURSER (1<<1)
#define F13INSTITUTESCI (1<<2)
#define F13ESCAPEDSYNTH (1<<3)
#define F13INSTITUTESYNTH (1<<4)
...
#define JOB_DISPLAY_ORDER_COURSERLEADER 128
#define JOB_DISPLAY_ORDER_COURSER	129
#define JOB_DISPLAY_ORDER_INSTITUTESCI 130
#define JOB_DISPLAY_ORDER_ESCAPEDSYNTH 131
#define JOB_DISPLAY_ORDER_INSTITUTESYNTH 132
