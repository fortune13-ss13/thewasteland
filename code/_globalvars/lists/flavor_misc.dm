...
GLOBAL_LIST_INIT(greyscale_limb_types, list("human",/*"moth","lizard","pod","plant","golem","mush","ethereal","snail","c_golem","b_golem","mammal","xeno","ipc","insect","synthliz","avian","aquatic"*/))
