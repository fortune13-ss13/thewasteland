...
/datum/design/medigax_torso
	...
	materials = list(/datum/material/iron=20000, /datum/material/glass=10000, /datum/material/gold=2000, /datum/material/silver=10000)
	construction_time = 300
	category = list("Medical-Spec Gygax")
...
/datum/design/medigax_head
	...
	materials = list(/datum/material/iron=10000,/datum/material/glass=5000, /datum/material/gold=5000, /datum/material/silver=5000)
	construction_time = 200
	category = list("Medical-Spec Gygax")
...
/datum/design/medigax_left_arm
	...
	materials = list(/datum/material/iron=15000, /datum/material/gold=4000, /datum/material/silver=4000)
	construction_time = 200
	category = list("Medical-Spec Gygax")
