...
/obj/item/reagent_containers/borghypo/borgshaker
	...
	recharge_time = 3
	accepts_reagent_upgrades = FALSE
	reagent_ids = list(/datum/reagent/consumable/ethanol/kahlua, /datum/reagent/consumable/ethanol/beer, /datum/reagent/consumable/ethanol/beer/light, /datum/reagent/consumable/ethanol/whiskey,/datum/reagent/consumable/ethanol/wine, /datum/reagent/consumable/ethanol/vodka, /datum/reagent/consumable/ethanol/gin, /datum/reagent/consumable/ethanol/rum, /datum/reagent/consumable/ethanol/tequila, /datum/reagent/consumable/ethanol/vermouth, /datum/reagent/consumable/ethanol/cognac, /datum/reagent/consumable/ethanol/ale, /datum/reagent/consumable/ethanol/absinthe, /datum/reagent/consumable/ethanol/hcider, /datum/reagent/consumable/ethanol/creme_de_menthe, /datum/reagent/consumable/ethanol/creme_de_cacao, /datum/reagent/consumable/ethanol/creme_de_coconut, /datum/reagent/consumable/ethanol/triple_sec, /datum/reagent/consumable/ethanol/sake, /datum/reagent/consumable/ethanol/applejack, /datum/reagent/consumable/ethanol/champagne, /datum/reagent/consumable/ethanol/fernet, /datum/reagent/consumable/ethanol, /datum/reagent/consumable/ethanol/atomicbomb, /datum/reagent/consumable/ethanol/thirteenloko, /datum/reagent/consumable/ethanol/changelingsting, /datum/reagent/consumable/ethanol/alexander, /datum/reagent/consumable/ethanol/beer/green, /datum/reagent/consumable/ethanol/trappist, /datum/reagent/consumable/ethanol/hooch, /datum/reagent/consumable/ethanol/mead, /datum/reagent/medicine/antihol, /datum/reagent/consumable/ethanol/rotgut, /datum/reagent/water, /datum/reagent/consumable/ice, /datum/reagent/consumable/coffee, /datum/reagent/consumable/cream, /datum/reagent/consumable/tea, /datum/reagent/consumable/icetea, /datum/reagent/consumable/space_cola, /datum/reagent/consumable/spacemountainwind, /datum/reagent/consumable/dr_gibb, /datum/reagent/consumable/space_up, /datum/reagent/consumable/tonic, /datum/reagent/consumable/sodawater, /datum/reagent/consumable/lemon_lime, /datum/reagent/consumable/pwr_game, /datum/reagent/consumable/shamblers, /datum/reagent/consumable/sugar, /datum/reagent/consumable/pineapplejuice, /datum/reagent/consumable/orangejuice, /datum/reagent/consumable/grenadine, /datum/reagent/consumable/limejuice, /datum/reagent/consumable/tomatojuice, /datum/reagent/consumable/lemonjuice, /datum/reagent/consumable/menthol, /datum/reagent/consumable/sunset, /datum/reagent/consumable/bawls, /datum/reagent/consumable/vim, /datum/reagent/consumable/nuka_cola, /datum/reagent/consumable/grapejuice, /datum/reagent/consumable/tea/forest, /datum/reagent/consumable/tea/red, /datum/reagent/consumable/tea/green, /datum/reagent/consumable/grey_bull, /datum/reagent/consumable/sol_dry, /datum/reagent/consumable/cream_soda, /datum/reagent/consumable/banana, /datum/reagent/consumable/berryjuice, /datum/reagent/consumable/strawberryjuice, /datum/reagent/consumable/applejuice, /datum/reagent/consumable/carrotjuice, /datum/reagent/consumable/pumpkinjuice, /datum/reagent/consumable/watermelonjuice, /datum/reagent/consumable/parsnipjuice, /datum/reagent/consumable/bungojuice, /datum/reagent/consumable/aloejuice, /datum/reagent/consumable/peachjuice, /datum/reagent/consumable/blumpkinjuice, /datum/reagent/consumable/vanilla, /datum/reagent/consumable/coco, /datum/reagent/consumable/lemonade, /datum/reagent/consumable/buzz_fuzz, /datum/reagent/consumable/menthol, /datum/reagent/drug/mushroomhallucinogen, /datum/reagent/consumable/laughter, /datum/reagent/consumable/monkey_energy)
...
/obj/item/reagent_containers/borghypo/peace
	...
	reagent_ids = list(/datum/reagent/peaceborg_confuse, /datum/reagent/peaceborg_tire, /datum/reagent/medicine/insulin)
	accepts_reagent_upgrades = FALSE

/obj/item/reagent_containers/borghypo/peace/hacked
	desc = "Everything's peaceful in death!"
	icon_state = "borghypo_s"
	reagent_ids = list(/datum/reagent/peaceborg_confuse, /datum/reagent/peaceborg_tire,
