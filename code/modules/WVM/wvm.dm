...
/obj/machinery/mineral/wasteland_vendor/denvendor
	...
	prize_list = list(
		new /datum/data/wasteland_equipment("Type93 Assault Rifle",			/obj/item/gun/ballistic/automatic/type93,							20),
		...
		new /datum/data/wasteland_equipment("Tear Gas Grenade",				/obj/item/grenade/chem_grenade/teargas								300),
		new /datum/data/wasteland_equipment("MK. 23",						/obj/item/gun/ballistic/automatic/pistol/mk23 						150),
		new /datum/data/wasteland_equipment("Stinger Grenade",				/obj/item/grenade/f13/stinger										35),
		new /datum/data/wasteland_equipment("HE Grenade",					/obj/item/grenade/syndieminibomb/concussion 						50),
		new /datum/data/wasteland_equipment("Frag Grenade",					/obj/item/grenade/syndieminibomb/concussion/frag 					35),
		new /datum/data/wasteland_equipment("C4",							/obj/item/grenade/plastic/c4 										85),
