...
/obj/item/seeds/tea/catnip
	...
	reagents_add = list(/datum/reagent/drug/methamphetamine/catnip = 0.1, /datum/reagent/consumable/nutriment/vitamin = 0.06, /datum/reagent/toxin/teapowder = 0.3)
	rarity = 50
...
/obj/item/reagent_containers/food/snacks/grown/tea/catnip
	...
	icon_state = "catnip"
	filling_color = "#4582B4"
	grind_results = list(/datum/reagent/drug/methamphetamine/catnip = 2, /datum/reagent/water = 1)
