...
/obj/item/clothing/head/helmet/f13/sulphitehelm
	...
	armor = list("melee" = 40, "bullet" = 40,"laser" = 35, "energy" = 20, "bomb" = 50, "bio" = 60, "rad" = 10, "fire" = 60, "acid" = 20, "wound" = 45)
...
/obj/item/clothing/head/helmet/knight/f13/metal
	...
	flags_inv = HIDEMASK|HIDEEARS|HIDEEYES|HIDEFACE|HIDEHAIR|HIDEFACIALHAIR
	armor = list("melee" = 35, "bullet" = 20, "laser" = 12, "energy" = 15, "bomb" = 45, "bio" = 30, "rad" = 15, "fire" = 60, "acid" = 0, "wound" = 45)
...
/obj/item/clothing/head/helmet/knight/f13/metal/reinforced
	...
	armor = list("melee" = 37, "bullet" = 22, "laser" = 15, "energy" = 16, "bomb" = 45, "bio" = 30, "rad" = 15, "fire" = 60, "acid" = 0, "wound" = 50)
...
/obj/item/clothing/head/helmet/f13/power_armor/t51b
	...
	armor = list("melee" = 72.5, "bullet" = 72.5, "laser" = 72.5, "energy" = 27, "bomb" = 62, "bio" = 100, "rad" = 99, "fire" = 90, "acid" = 40, "wound" = 70)
	actions_types = list(/datum/action/item_action/toggle_helmet_light)
...
/obj/item/clothing/head/helmet/f13/tribal
	...
	item_state = "tribal"
	flags_cover = HEADCOVERSEYES | HEADCOVERSMOUTH
	armor = list("melee" = 50, "bullet" = 25, "laser" = 25, "energy" = 15, "bomb" = 72, "bio" = 100, "rad" = 100, "fire" = 90, "acid" = 0, "wound" = 90)
	flags_inv = HIDEMASK|HIDEEARS|HIDEEYES|HIDEFACE|HIDEHAIR|HIDEFACIALHAIR
	strip_delay = 30
	dynamic_hair_suffix = ""
	dynamic_fhair_suffix = ""
...
/obj/item/clothing/head/f13/pot
	...
	flags_inv = HIDEHAIR
	armor = list("melee" = 30, "bullet" = 15, "laser" = 20, "energy" = 10, "bomb" = 15, "bio" = 0, "rad" = 0, "fire" = 30, "acid" = 0)
...
/obj/item/clothing/head/helmet/f13/wastewarhat
	...
	icon_state = "wastewar"
	item_state = "wastewar"
	armor = list("melee" = 25, "bullet" = 15, "laser" = 15, "energy" = 10, "bomb" = 15, "bio" = 0, "rad" = 0, "fire" = 30, "acid" = 0)
	flags_inv = HIDEEARS|HIDEHAIR
