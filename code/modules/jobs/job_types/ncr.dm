...
/datum/job/ncr/f13drillsergeant
	...
	total_positions = 1
	spawn_positions = 1
	description = "You are the direct superior to the conscripts, you are to provide training exercises, maintain military discipline, and instill orderliness within the ranks. You may also manage the NCOs. You are the pinnacle of the NCR's enlisted ranks, and are to advise the commissioned officers."
...
/datum/job/ncr/f13ranger
	...
	/datum/outfit/loadout/rangerpatrol, // Assault Rifle, .44 SA Revolver
...
/datum/job/ncr/f13combatengineer
	...
	loadout_options = list( // ALL: Trench tool, Limited blueprints
		...
		/datum/outfit/loadout/combatengineerrocketeer, //rocket launcher, m1/n carbine
		)
...
/datum/job/ncr/f13conscript
	...
	loadout_options = list(
		...
		/datum/outfit/loadout/conscripthunting, // hunting shotgun, Trench tool, Sandbags
		)
