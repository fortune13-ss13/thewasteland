...
/datum/job/ncr/f13provostmarshal
	...
	outfit = /datum/outfit/job/ncr/f13provostmarshal
	exp_requirements = 1500

/datum/outfit/job/ncr/f13provostmarshal		// .44 Revolver, Riot Shotgun, Military baton
...
/datum/outfit/job/ncr/f13provostmarshal/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	..()
	if(visualsOnly)
		return
	ADD_TRAIT(H, TRAIT_GENERIC, src)
